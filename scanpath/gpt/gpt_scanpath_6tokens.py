...
def generate_openai_sum(code):
    ...
    '''
    example_scanpath1 = '''capitalizeString String String.2 0 < 0 1'''
    
    example_scanpath2 = '''= s.substring result capitalizeString String.1 public'''

    example_scanpath3 = '''int i =.1 i.1 int for'''

    example_scanpath4 = '''s.length int s.substring.1 0.1 if ).toUpperCase'''

    example_scanpath5 = '''iresult String public String i i.1'''
...
if __name__=='__main__':
    ...
    testfiles = []
    pf = open(f'scanpath_results_6tokens/{prediction_filename}', 'w')
    for file in testarr:
