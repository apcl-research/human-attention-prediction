...
for file in /nfs/projects/scanpath/scanpath_prediction/bansal_dataset/reading/byFunction_*/; do
	...
	python3 metrics_func.py --holdout=$id --pred-dir=${pred_dir} --out=$CSV_FILE --N=5 --pids=/nfs/projects/scanpath/scanpath_prediction/bansal_dataset/reading/allfids.pkl --ref-file=/nfs/projects/scanpath/scanpath_prediction/bansal_dataset/reading
