...
if __name__ == "__main__":
    ...
    parser.add_argument("--holdout", type=str, default="p2")
    ...
    torch.save(model.state_dict(), f"./smith_study/{holdout_set}/model_weights_{holdout_set}.pth")
    ...
    pickle.dump(output_dict, open(f"./smith_study/{holdout_set}/results_{holdout_set}.pkl", "wb"))
    r, p = pearsonr(refs, preds)
    file_path = "./smith_study/correlation_smith_study.csv"
