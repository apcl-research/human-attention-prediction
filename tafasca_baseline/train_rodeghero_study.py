...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), f"./rodeghero_study/{holdout_set}/model_weights_{holdout_set}.pth")
    ...
    pickle.dump(output_dict, open(f"./rodeghero_study/{holdout_set}/results_{holdout_set}.pkl", "wb"))
    r, p = pearsonr(refs, preds)
    file_path = "./rodeghero_study/correlation_rodeghero_study.csv"
